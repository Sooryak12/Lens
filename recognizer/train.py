...
if __name__ == '__main__':
    ...
    train_loader = Generator(root_path=train_image_dir,
                             input_map_file=os.path.join(txt_dir, 'real_train.txt'),
                             batch_size=batch_size,
                             max_label_length=max_label_length,
                             input_shape=(32, 280, 3),
                             is_training=True)

    valid_loader = Generator(root_path=test_image_dir,
                            input_map_file=os.path.join(txt_dir, 'real_test.txt'),
                            batch_size=batch_size,
                            max_label_length=max_label_length,
                            input_shape=(32, 280, 3),
                            is_training=True)
